...
The 2026-08-24 pinned run shows that PySonar2 4.1.0 loads declared Python source encodings and
...
| TypeEvalPy type gold | 386/868 exact (44.47%) | 387 wrong and 95 missing inferred types; broad type-inference correctness is not established |
...
| Preserved PySonar2 types | 132/300 exact (44.00%) | substantially improved, but Java-era inferred-type compatibility remains partial |
...
classes (73/122), assignments (58/82), dictionaries (48/107), lists (33/60), MRO (23/34), and
functions (24/37).
...
[`benchmarks/conformance`](../benchmarks/conformance/README.md). Aggregate results and links to the
adjacent per-query JSONL records are stored in:
