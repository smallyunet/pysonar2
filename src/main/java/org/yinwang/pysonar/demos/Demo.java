...
public class Demo {
    ...
    private String landingMarkup(@NotNull List<String> files) {
        ...
        return "<!doctype html>\n<html lang='en'><head>"
                ...
                + "<span class='release-pill'>Python 3-only · v3.3.1</span>"
    ...
    private static void usage() {
        $.msg("Usage:  java -jar pysonar-3.3.1.jar <file-or-dir> <output-dir>");
        $.msg("Example that generates an index for a Python 3 standard library:");
        $.msg(" java -jar pysonar-3.3.1.jar /usr/lib/python3 ./html");
        System.exit(0);
    }
